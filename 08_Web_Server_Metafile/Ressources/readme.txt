...
- I loaded the http://192.168.56.101/robots.txt page. 2 paths seem available; I tried the first one to start: http://192.168.56.101/whatever/
...
- Maybe the password is hashed. I tried to decode the hash '8621ffdbc5698829397d97767ac13db3' using https://www.dcode.fr/fonction-hash and its encryption automatic detection. A word is found 'dragon'
- I tried this time the [root, dragon] couple on the http://192.168.56.101/index.php?page=signin page, with no success
- After a few pieces of research on the web, I found a few methods to start a web crawler on the website. The first method, 'wget -r -l0 192.168.56.101', was not really interesting for the moment. 
