...
- I first checked what you could receive when you put an int: you get details about members(ID, First name, Surname)
- I immediately tried to inject a SQL command, 1 UNION SELECT * FROM members WHERE Surname = 'administrator'--'
